...
def canUnlockAll(boxes):
    ...
    if len(sorted_keys) == (no_boxes - 1):  # we know we have same no unique keys as with the no of boxes
        # but are these unique keys capable of opeming each box i.e do they match each individual box?, asides the already opened 0th box)
        """
        i = 0
